 ...
 * @Description: 汉明距离：0-首选-位运算；1-内置位计数功能；2-移位；3-布赖恩·克尼根算法（x&(x-1)）
 */
public class Solution {
    ...
    public void test() {
        ...
        //System.out.println(hammingDistance1(1, 7));
        //System.out.println(hammingDistance2(1, 7));
        //System.out.println(hammingDistance3(1, 7));
    }
}
